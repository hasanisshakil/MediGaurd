...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Thank You - MediGuard</title>
    ...
    <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-4 bg-light p-3 rounded-3">
              <p class="text-justify">Dear  <b class="text-primary"><?php  echo $client_email; ?></b>,<h4>Thank You For Your Request! to become a client as <strong><?php  echo $client_company; ?> </strong>.Please Wait for approval. Keep eyes on your Mail.</h4></p>
